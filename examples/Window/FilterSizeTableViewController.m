//
//  FilterSizeTableViewController.m
//  Window
//
...
@interface FilterSizeTableViewController ()

@end

@implementation FilterSizeTableViewController
...
- (void)save {
    ...
    [self.delegate updateSizeFilterDescriptionWithString:filterString];
...
- (void)storeData:(NSMutableArray *)selectedIndexPathRows {
    ...
    [userDefaults setObject:selectedIndexPathRows forKey:@"sizeIndexPathRowsNew"];
...
- (void)retrieveData {
    NSLog(@"retrieveData");
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    NSArray *selectedIndexPathRows = [userDefaults arrayForKey:@"sizeIndexPathRowsNew"];
