//
//  FilterGenderTableViewController.m
//  Window
//
...
@interface FilterGenderTableViewController ()

@end

@implementation FilterGenderTableViewController
...
- (void)save {
    ...
    [self.delegate updateGenderFilterDescriptionWithString:filterString];
...
- (void)storeData:(NSMutableArray *)selectedIndexPathRows {
    ...
    [userDefaults setObject:selectedIndexPathRows forKey:@"genderIndexPathRowsNew"];
    [userDefaults synchronize];
}

- (void)retrieveData {
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    NSArray *selectedIndexPathRows = [userDefaults arrayForKey:@"genderIndexPathRowsNew"];
