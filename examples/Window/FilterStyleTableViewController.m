//
//  FilterStyleTableViewController.m
//  Window
//
...
@interface FilterStyleTableViewController ()

@end

@implementation FilterStyleTableViewController
...
- (void)save {
    ...
    [self.delegate updateStyleFilterDescriptionWithString:filterString];
...
- (void)storeData:(NSMutableArray *)selectedIndexPathRows {
    ...
    [userDefaults setObject:selectedIndexPathRows forKey:@"styleIndexPathRowsNew"];
...
- (void)retrieveData {
    NSLog(@"retrieveData");
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    NSArray *selectedIndexPathRows = [userDefaults arrayForKey:@"styleIndexPathRowsNew"];
